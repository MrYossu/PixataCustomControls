...
namespace PixataCustomControls.Editors.ColourPicker {
  ...
  internal class ColourSpace {
    ...
    public Color GetColourFromPosition(double position) {
      int gradientStops = 6;
      ...
      switch ((int)(position/MAX)) {
        case 0:
          return Color.FromArgb(MAX, MAX, mod, MIN);
        case 1:
          return Color.FromArgb(MAX, diff, MAX, MIN);
        case 2:
          return Color.FromArgb(MAX, MIN, MAX, mod);
        case 3:
          return Color.FromArgb(MAX, MIN, diff, MAX);
        case 4:
          return Color.FromArgb(MAX, mod, MIN, MAX);
        case 5:
          return Color.FromArgb(MAX, MAX, MIN, diff);
        case 6:
          return Color.FromArgb(MAX, MAX, mod, MIN);
        default:
          return Colors.Black;
