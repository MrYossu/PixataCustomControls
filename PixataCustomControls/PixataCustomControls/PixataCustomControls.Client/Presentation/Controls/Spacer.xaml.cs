...
namespace PixataCustomControls.Presentation.Controls {
  ...
  [ControlFactory("PixataCustomControls:Spacer")]
  internal class SpacerFactory : IControlFactory {
    #region IControlFactory Members

    public DataTemplate DataTemplate {
      get {
        if (null == this.dataTemplate) {
          this.dataTemplate = XamlReader.Load(SpacerFactory.ControlTemplate) as DataTemplate;
        }
