...
namespace PixataCustomControls.Presentation.Controls {
  ...
  [ControlFactory("PixataCustomControls:VerticalDivider")]
  internal class VerticalDividerFactory : IControlFactory {
    #region IControlFactory Members

    public DataTemplate DataTemplate {
      get {
        if (null == this.dataTemplate) {
          this.dataTemplate = XamlReader.Load(VerticalDividerFactory.ControlTemplate) as DataTemplate;
        }
