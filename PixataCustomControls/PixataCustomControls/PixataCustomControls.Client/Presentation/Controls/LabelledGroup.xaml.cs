...
namespace PixataCustomControls.Presentation.Controls {
  public partial class LabelledGroup : UserControl {
    public LabelledGroup() {
      InitializeComponent();
    }
  }

  [Export(typeof(IControlFactory))]
  [ControlFactory("PixataCustomControls:LabelledGroup")]
  internal class LabelledGroupFactory : IControlFactory {
    #region IControlFactory Members

    public DataTemplate DataTemplate {
      get {
        if (null == this.dataTemplate) {
          this.dataTemplate = XamlReader.Load(LabelledGroupFactory.ControlTemplate) as DataTemplate;
        }
