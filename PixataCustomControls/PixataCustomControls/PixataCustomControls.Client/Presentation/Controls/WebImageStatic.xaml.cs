...
namespace PixataCustomControls.Presentation.Controls {
  public partial class WebImageStatic : UserControl {
    public WebImageStatic() {
      InitializeComponent();
    }
  }

  [Export(typeof(IControlFactory))]
  [ControlFactory("PixataCustomControls:WebImageStatic")]
  internal class WebImageStaticFactory : IControlFactory {
    #region IControlFactory Members

    public DataTemplate DataTemplate {
      get {
        if (null == this.dataTemplate) {
          this.dataTemplate = XamlReader.Load(WebImageStaticFactory.ControlTemplate) as DataTemplate;
        }
