...
namespace PixataCustomControls.Presentation.Controls {
  public partial class HorizontalDivider : UserControl {
  ...
  [ControlFactory("PixataCustomControls:HorizontalDivider")]
  internal class HorizontalDividerFactory : IControlFactory {
    #region IControlFactory Members

    public DataTemplate DataTemplate {
      get {
        if (null == this.dataTemplate) {
          this.dataTemplate = XamlReader.Load(HorizontalDividerFactory.ControlTemplate) as DataTemplate;
        }
