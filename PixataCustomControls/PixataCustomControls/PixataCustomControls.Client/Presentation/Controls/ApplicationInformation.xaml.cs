...
namespace PixataCustomControls.Presentation.Controls {
  ...
  [ControlFactory("PixataCustomControls:ApplicationInformation")]
  internal class ApplicationInformationFactory : IControlFactory {
    #region IControlFactory Members

    public DataTemplate DataTemplate {
      get {
        if (null == this.dataTemplate) {
          this.dataTemplate = XamlReader.Load(ApplicationInformationFactory.ControlTemplate) as DataTemplate;
        }
